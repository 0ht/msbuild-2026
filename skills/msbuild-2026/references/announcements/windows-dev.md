...
Windows 開発者向けプラットフォーム全体の Build 2026 更新として、Windows Development Configurations（GA）、Coreutils for Windows（GA）、WSL containers、Intelligent Terminal v0.1、Windows AI APIs の拡張（Aion 1.0 SLM）、Windows プラットフォームセキュリティ for AI エージェントを発表。個別の発表は専用エントリに分離。
