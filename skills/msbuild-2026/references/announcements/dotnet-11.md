...
.NET 11 Preview で C# に union types を導入し、ワイヤプロトコルやドメインモデリングの閉じたデータ形状を型安全にモデル化可能にした。AI Building Blocks、ASP.NET Core のエージェンティック Web 対応、.NET MAUI でのエッジ AI、新インストーラ dotnetup を発表。ランタイム・ライブラリ・SDK 全体で AI 時代のインテリジェントアプリ開発に最適化。
...
- [https://devblogs.microsoft.com/dotnet/dotnet-at-microsoft-build-2026/](https://devblogs.microsoft.com/dotnet/dotnet-at-microsoft-build-2026/)
- [https://dotnet.microsoft.com/download/dotnet/11.0](https://dotnet.microsoft.com/download/dotnet/11.0)
