...
[Microsoft Build CLI](https://github.com/microsoft/Build-CLI) は GitHub Copilot CLI のスキルプラグインで、ローカルプロジェクトを Build セッションカタログに接続する。依存関係を読み取り、関連セッションを検索し、学んだ内容をアクションに変換する。

- インストール: `/plugin install microsoft/Build-CLI` (GitHub Copilot CLI)
- VS Code: `@agentPlugins microsoft-events` で検索
...
- [Microsoft Build CLI](https://github.com/microsoft/Build-CLI)
