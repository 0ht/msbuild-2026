...
summary: >-
  GitHub Copilot が自律的にタスクを計画・実行する Agent Mode の精度向上とターミナル統合強化に加え、
  エディタ非依存のデスクトップアプリ GitHub Copilot App を Preview で発表。
  また Copilot SDK により、Agent Mode と同じランタイムを使ったカスタムエージェントの構築が可能に。
  マルチファイル編集の精度向上と MCP サーバー連携により、開発ワークフローの自動化範囲が拡大。
tags:
  - github-copilot
...
official_sources:
  ...
  - https://code.visualstudio.com/docs/copilot/chat/agent-mode
deliveries:
  site: true
  llms: true
  skills: true
...
- [Agent Mode ドキュメント](https://code.visualstudio.com/docs/copilot/chat/agent-mode)
