---
id: key01
title: Build 2026 Opening Keynote
summary: Satya Nadella が登壇した Build 2026 オープニングキーノート。Microsoft IQ・7つの MAI モデル・Microsoft Agent Platform・Majorana 2 量子チップ・Surface RTX Spark Dev Box・Project Solara を含む主要発表を行い、「エージェントが組織固有の知識を持つ」「フルスタックを自分流に構築する」「科学と量子の未来」の3テーマを展開した。
tags:
  - azure-ai-foundry
  - github-copilot
  - microsoft-iq
...
- [Build 2026 Official News Site](https://news.microsoft.com/build-2026)
- [Microsoft Build Live（リアルタイムブログ）](https://news.microsoft.com/build-2026-live-blog/microsoft-build-2026-live)
- [Official Microsoft Blog: Microsoft Build 2026: Be yourself at work](https://blogs.microsoft.com/blog/2026/06/02/microsoft-build-2026-be-yourself-at-work)
- [キーノートトランスクリプト（PDF）](https://news.microsoft.com/source/wp-content/uploads/2026/06/06022026_Nadella_TRANSCRIPT_Build-Keynote.pdf)
- [Build 2026 セッションカタログ — KEY01](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775670526436001p1Pd)

## 関連エントリ

- [Microsoft IQ](../announcements/microsoft-iq.md) — キーノートで発表された統合コンテキストレイヤー
- [MAI Models](../announcements/mai-models.md) — Mustafa Suleyman が発表した7つの新モデルファミリー
- [Microsoft Foundry](../announcements/microsoft-foundry.md) — エージェント開発・デプロイプラットフォーム
- [GitHub Copilot App](../announcements/github-copilot-app.md) — キーノートでデモされたエージェントネイティブデスクトップアプリ
- [Microsoft Scout](../announcements/microsoft-scout.md) — 初の Autopilot カテゴリエージェント
- [Frontier Tuning](../announcements/frontier-tuning.md) — 組織固有の強化学習
- [Surface RTX Spark Dev Box](../announcements/surface-rtx-spark-dev-box.md) — NVIDIA RTX Spark 搭載の開発者向けデバイス
- [Project Solara](../announcements/project-solara.md) — エージェントファーストデバイスプラットフォーム
- [Rayfin](../announcements/rayfin.md) — Fabric 上のバックエンドサービス
- [Microsoft Discovery](../announcements/microsoft-discovery.md) — 科学研究向け AI プラットフォーム
- [Majorana 2](../announcements/majorana-2.md) — 次世代量子コンピューティングチップ
- [Responsible AI](../announcements/responsible-ai.md) — ASSERT と Agent Control Specification
- [Windows Development](../announcements/windows-dev.md) — Windows 開発者プラットフォームの更新
- [Foundry Local](../announcements/foundry-local.md) — ローカル AI 推論基盤
