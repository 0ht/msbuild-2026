---
id: brksp94
title: "Orchestrate special agents with NVIDIA Nemotron models on Foundry"
summary: NVIDIA Nemotron モデルファミリー（Nano/Super/Ultra）と Microsoft Foundry Hosted Agents を組み合わせた階層型エージェント・アーキテクチャを解説。Hermes Agent ハーネスによるマルチモデル・オーケストレーション、Foundry Toolbox による MCP サーバー統合管理、Entra ID を活用したエージェント ID ガバナンス、スキル学習メカニズムによる継続的改善のデモを通じて、コスト効率とタスク品質を両立するエンタープライズ・エージェント構築手法を提示するセッション。
tags:
  - azure-ai-foundry
  - agent-framework
  - microsoft-entra
...
official_sources:
  - https://build.microsoft.com/sessions/BRKSP94
deliveries:
  site: true
  llms: true
  skills: true
...
- [NVIDIA Nemotron モデル（Hugging Face）](https://huggingface.co/nvidia)
- [Microsoft Foundry Hosted Agents ドキュメント](https://learn.microsoft.com/azure/ai-services/agents/)
- [Hermes Agent](https://github.com/hermes-ai/hermes-agent)

## 関連エントリ

- [Microsoft Foundry](../announcements/microsoft-foundry.md)
- [MAI Models](../announcements/mai-models.md)
